...
export default function Schedule() {
  ...
  const schedulePushNotification = async (item) => {
    ...
    Alert.alert(
      "Notification set",
      `Your notification has been scheduled for ${trigger.toLocaleString()}.`
    );
    setTitle("");
    setMessage("");
    setTime(new Date());
  ...
  return (
    <ImageBackground
      source={require("../../../assets/background/people.png")}
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View>
            ...
            <Modal visible={modalVisible} animationType="slide">
              <ImageBackground
                source={require("../../../assets/background/bgmenuu.png")}
                style={{ flex: 1 }}
              >
                <Card style={styles.addModal}>
                  ...
                  <Card.Content>
                    ...
                    >
                      ...
                      <Picker.Item
                        label="Daily Scriptural Readings"
                        value="Daily Scriptural Readings"
                      />
                      <Picker.Item
                        label="Liturgical Songs"
                        value="Liturgical Songs"
                      />
                      <Picker.Item label="Icons" value="Icons" />
                      <Picker.Item
                        label="Sa Iyong Tahanan"
                        value="Sa Iyong Tahanan"
                      />
                      <Picker.Item
                        label="Religious And Inspirational Videos"
                        value="Religious And Inspirational Videos"
                      />
                      <Picker.Item
                        label="The Lord Is My Chef"
                        value="The Lord Is My Chef"
                      />
                      <Picker.Item
                        label="Tinig ng Pastol"
                        value="Tinig ng Pastol"
                      />
                      <Picker.Item label="Cross Word" value="Cross Word" />
                      <Picker.Item label="OOTD" value="OOTD" />
                      <Picker.Item
                        label="Sa Madaling Sabi"
                        value="Sa Madaling Sabi"
                      />
                      <Picker.Item
