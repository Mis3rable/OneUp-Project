...
import { FlatList, Modal, Text, TouchableOpacity, View, SafeAreaView, StyleSheet, ImageBackground } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      <ImageBackground source={require('../../../../../assets/background/outside.png')} style={styles.background}>
        <View style={styles.list}>
          <Text style={styles.title}> "Spiritual recipes for the soul to gladden your heart."</Text>
            <FlatList 
              data={folders}
              renderItem={({ item }) => (
                <TouchableOpacity onPress={() => setSelectedFolder(item)} style={styles.folderList}>
                  ...
                  <Ionicons name="close-circle" size={30} color="saddlebrown" style={styles.icon}/>
                    ...
                    <Text style={styles.modalTitle}>"{selectedFolder}"</Text>
                      <FlatList
                        data={subFolders}
                        renderItem={({ item }) => (
                          <TouchableOpacity onPress={() => setSelectedSubFolder(item)} style={styles.modalList}>
